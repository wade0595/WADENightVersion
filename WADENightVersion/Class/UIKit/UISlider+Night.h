...
@property (nonatomic, copy) IBInspectable NSString *wd_minimumTrackTintColorPicker;

@property (nonatomic, copy) IBInspectable NSString *wd_maximumTrackTintColorPicker;
