...
@property (nonatomic, copy) IBInspectable NSString *wade_minimumTrackTintColorPicker;

@property (nonatomic, copy) IBInspectable NSString *wade_maximumTrackTintColorPicker;
