...
-(void)setWd_pageIndicatorTintColorPicker:(NSString *)wd_pageIndicatorTintColorPicker
{
...
-(void)setWd_currentPageIndicatorTintColorPicker:(NSString *)wd_currentPageIndicatorTintColorPicker
{
